          ...
          <div className="container mx-auto px-4 max-w-md">
            <Card className="border-primary/30 bg-card/80 backdrop-blur-sm glow-cyan">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-3xl text-primary">ВХОД</CardTitle>
            ...
            <TabsContent value="overview" className="space-y-6">
              ...
              <Card className="border-primary/30 bg-card/80 backdrop-blur-sm">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <Button 
                    onClick={() => toast({ title: "Настройка", description: "Функция в разработке" })}
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch 
                      ...
                      onCheckedChange={(checked) => setNotifications({...notifications, subscription: checked})}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                    ...
                    <Switch 
                      ...
                      onCheckedChange={(checked) => setNotifications({...notifications, features: checked})}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="border-accent/30 bg-card/80 backdrop-blur-sm">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button 
                      onClick={handleTopUp}
                      className="w-full bg-accent hover:bg-accent/80 text-accent-foreground glow-purple"
                    >
                      <Icon name="Plus" className="mr-2 h-4 w-4" />
                      Пополнить баланс
                    </Button>
